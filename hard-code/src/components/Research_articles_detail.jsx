...
const Research_articles_detail = () => {
    return (
        <>
            <Helmet>
                <title>Research Article Detail | OHIO</title>
            </Helmet>
            <Banner_line pagename="My OHIO" tagline="Research Articles Detail" />
                        ...
                        <div className="col-xs-12 col-sm-8 col-md-8 col-lg-9">
                            <div className="right_area">
                                ...
                                <ol className="breadcrumb">
                                    ...
                                    <li><NavLink to="/research-articles">Rearch Articles</NavLink></li>
                                    <li>Research Articles Detail</li>
                                </ol>
                                <h1 className="heading">Research Articles Detail</h1>
...
export default Research_articles_detail;