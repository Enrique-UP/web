...
const Research_publication = () => {
    return (
        <>
            <Helmet>
                <title>Research Publication | OHIO</title>
            </Helmet>
            <Banner_line pagename="Students" tagline="Online Research Publications" />
                            ...
                            <div className="right_area for_right_sidebar_padding">
                                ...
                                <div className="middle_area">
                                    <ol className="breadcrumb">
                                        ...
                                        <li>Online Research Publications</li>
                                    </ol>
                                    <h1 className="heading">Online Research Publications</h1>
...
export default Research_publication;