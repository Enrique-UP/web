...
const Diversity_policy = () => {
    return (
        <>
            <Helmet>
                <title>Diversity Policy | OHIO</title>
            </Helmet>
            <Banner_line pagename="MY OHIO" tagline="Diversity Policy" />
                        ...
                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div className="right_area for_right_sidebar_padding">
                                ...
                                <div className="middle_area">
                                    ...
                                    <h1 className="heading">Diversity Policy</h1>
...
export default Diversity_policy;