...
const Credit_transfer_policy = () => {
    return (
        <>
            <Helmet>
                <title>Credit Transfer Policy | OHIO</title>
            </Helmet>
            <Banner_line pagename="MY OHIO" tagline="Credit Transfer Policy" />
                        ...
                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div className="right_area for_right_sidebar_padding">
                                ...
                                <div className="middle_area">
                                    ...
                                    <p><strong>Website:-</strong> <NavLink to="/">www.ohio.com</NavLink></p>
                                    <p><strong>Email ID:-</strong> <a href="maito:info@ohio.com" target="_blank">info@ohio.com</a></p>
                                    <p><strong>Phone No.:-</strong> <a href="tel:+1-000-000-0000" target="_blank">+1-000-000-0000</a></p>
                                    <Bottom_counter />               
                                </div>{/*--middle_area--*/}
                                <Right_sidebar />
                            </div>{/*--right_area--*/}
...
export default Credit_transfer_policy;