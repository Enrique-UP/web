...
const Student_grievances = () => {
    return (
        <>
            <Helmet>
                <title>Student Grievances | OHIO</title>
            </Helmet>
            <Banner_line pagename="MY OHIO" tagline="Student Grievances" />
                        ...
                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div className="right_area for_right_sidebar_padding">
                                ...
                                <div className="middle_area">
                                    ...
                                    <h1 className="heading">Student Grievances</h1>
...
export default Student_grievances;