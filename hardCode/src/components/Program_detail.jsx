...
const Program_detail = () => {
    return (
        <>
            <Helmet>
                <title>Program Detail | OHIO</title>
            </Helmet>
            <Banner_line pagename="Programs" tagline="OHIO Program Detail" />
                                    ...
                                    <div className="row">
                                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <ol className="breadcrumb">
                                                ...
                                                <li>OHIO Program Detail</li>
                                            </ol>
                                        </div>{/*--cols--*/}
                                    </div>{/*--row--*/}
                                    <Course code="OHIO0001" course="Program Detail" />
                                    <Bottom_counter />               
                                </div>{/*--middle_area--*/}
                                <Right_sidebar />
                            </div>{/*--right_area--*/}
