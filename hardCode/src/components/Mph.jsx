...
const Mph = () => {
    return (
        <>
            <Helmet>
                <title>MPH | OHIO</title>
            </Helmet>
            <Banner_line pagename="Programs" tagline="OHIO MPH" />
                                    ...
                                    <div className="row">
                                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <ol className="breadcrumb">
                                                ...
                                                <li>OHIO Master in Public Health</li>
                                            </ol>
                                        </div>{/*--cols--*/}
                                    </div>{/*--row--*/}
                                    <Course code="OHIO0004" course="Master in Public Health" />
                                    <Bottom_counter />               
                                </div>{/*--middle_area--*/}
                                <Right_sidebar />
                            </div>{/*--right_area--*/}
