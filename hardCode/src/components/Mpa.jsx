...
const Mpa = () => {
    return (
        <>
            <Helmet>
                <title>MPA | OHIO</title>
            </Helmet>
            <Banner_line pagename="Programs" tagline="OHIO MPA" />
                                    ...
                                    <div className="row">
                                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <ol className="breadcrumb">
                                                ...
                                                <li>OHIO Master of Public Administration</li>
                                            </ol>
                                        </div>{/*--cols--*/}
                                    </div>{/*--row--*/}
                                    <Course code="OHIO0005" course="Master of Public Administration" />
                                    <Bottom_counter />               
                                </div>{/*--middle_area--*/}
                                <Right_sidebar />
                            </div>{/*--right_area--*/}
