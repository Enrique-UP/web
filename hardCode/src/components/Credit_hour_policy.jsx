...
const Credit_hour_policy = () => {
    return (
        <>
            <Helmet>
                <title>Credit Hour Policy | OHIO</title>
            </Helmet>
                            ...
                            <div className="right_area for_right_sidebar_padding">
                                ...
                                <div className="middle_area">
                                    <ol className="breadcrumb">
                                        ...
                                        <li>Credit Hour Policy</li>
                                    </ol>
                                    <h1 className="heading">Credit Hour Policy</h1>
...
export default Credit_hour_policy;