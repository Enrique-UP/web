...
const Enrollment_verification = () => {
    return (
        <>
            <Helmet>
                <title>Enrollment Verification | OHIO</title>
            </Helmet>
            <Banner_line pagename="MY OHIO" tagline="Enrollment Verification" />
                        ...
                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div className="right_area for_right_sidebar_padding">
                                ...
                                <div className="middle_area">
                                    ...
                                    <h1 className="heading">Enrollment Verification</h1>
                                    ...
                                    <p className="heading_p">Degree Verification</p>
...
export default Enrollment_verification;